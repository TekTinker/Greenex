...
public class RawFragment  extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        productsView = inflater.inflate(R.layout.fragment_raw,container,false);

        progressDialog = new ProgressDialog(getContext());
        progressDialog.setMessage("Loading...");

        tvRefresh = (TextView) productsView.findViewById(R.id.tvRefresh_Raw);

        swipeRefreshLayout = (SwipeRefreshLayout) productsView.findViewById(R.id.raw_swipeToRefresh);
        ...
        recyclerView = (RecyclerView) productsView.findViewById(R.id.raw_recyclerView);
    ...
    private void loadProducts(){
        ...
        String url = AppController.getInstance().getServer() + "raw?page=" + page;
